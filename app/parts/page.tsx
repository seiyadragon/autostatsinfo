...
export const metadata = {
  ...
  description: "Learn about all the different parts in your car or bike, what they do, and how they work.",
  keywords: "cars, motorcycles, trucks, parts, brands, vehicles, engines, tires, brakes, suspension, steering, transmission, exhaust, fuel, cooling, electrical, lighting, interior, exterior",
};

const PartsPage = async (props: any) => {
  ...
  return (
    <>
        <HeroLite title="CHECK OUT THE TOP" subtitle="PARTS"/>
