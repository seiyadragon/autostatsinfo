...
const pageName = "Steering";

export const metadata = {
  metadataBase: new URL(defaultUrl),
  title: `${pageName} - ASI: Know your ride`,
  description: "Learn about all the different types of steering systems in your car or bike, what they do, and how they work.",
  keywords: "steering systems, rack and pinion, recirculating ball, power steering, cars, motorcycles, trucks, vehicles",
};

const SteeringPage = async (props: any) => {
    const parts = await eqDataLoading("CarParts", ["type", "steering"]);
  ...
  return (
    <>
        <HeroLite title="CHECK OUT THE TOP" subtitle="STEERING SYSTEMS"/>
