...
const pageName = "Engines";

export const metadata = {
  metadataBase: new URL(defaultUrl),
  title: `${pageName} - ASI: Know your ride`,
  description: "Learn about all the different types of engines in your car or bike, what they do, and how they work.",
  keywords: "engines, v6, v8, v12, rotary, boxer, inline, flat, diesel, electric, hybrid, cars, motorcycles, trucks, vehicles",
};

const EnginesPage = async (props: any) => {
    const parts = await eqDataLoading("CarParts", ["type", "engine"]);
  ...
  return (
    <>
        <HeroLite title="CHECK OUT THE TOP" subtitle="ENGINES"/>
