...
const pageName = "Electrical";

export const metadata = {
  metadataBase: new URL(defaultUrl),
  title: `${pageName} - ASI: Know your ride`,
  description: "Learn about all the different types of electrical systems in your car or bike, what they do, and how they work.",
  keywords: "electrical systems, battery, alternator, starter, ignition, spark plugs, cars, motorcycles, trucks, vehicles",
};

const ElectricalPage = async (props: any) => {
    const parts = await eqDataLoading("CarParts", ["type", "electrical"]);
  ...
  return (
    <>
        <HeroLite title="CHECK OUT THE TOP" subtitle="ELECTRICAL SYSTEMS"/>
